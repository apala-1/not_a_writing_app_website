...
export default function Footer() {
  return (
    <div>
       {/* Footer */}
      <footer className="relative z-10 bg-white/80 backdrop-blur-md shadow-lg mt-auto">
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-gray-600 mb-4 max-w-md">
                A calm space for writers to create, share, and collect their work. Write freely, organize beautifully.
              </p>
              <div className="flex gap-4">
                <a href="#" className="w-10 h-10 bg-gray-100 hover:bg-orange-100 rounded-full flex items-center justify-center text-gray-600 hover:text-orange-600 transition-all duration-200">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="/features" className="text-gray-600 hover:text-orange-600 transition-colors duration-200">Features</Link></li>
                <li><Link href="/pricing" className="text-gray-600 hover:text-orange-600 transition-colors duration-200">Pricing</Link></li>
                <li><Link href="/templates" className="text-gray-600 hover:text-orange-600 transition-colors duration-200">Templates</Link></li>
                <li><Link href="/changelog" className="text-gray-600 hover:text-orange-600 transition-colors duration-200">Changelog</Link></li>
              </ul>
            </div>
